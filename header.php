...
<div id="tooplate_wrapper">
    ...
    <div class="img007"><img src="hopehm.jpg" width="173px" height="93px" /></div>
   	 <br /><br />
    ...
    <div id="tooplate_menu">
        <ul>
            ...
            <li><a href="Form/memberlogin_form.php">Login</a></li>
            <li><a href="Form/registration_form.php">Register</a></li>
