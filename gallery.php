...
$sql1="SELECT * FROM `gallery_table`";
...
echo "<img src='action/gal/$pic' width='125px' height='125px'>";echo"</a>";echo"<br />
";
...
echo"<div class='pics'>";
	echo"<img class='img-responsive ig' src='action/gal/$pic 'alt=''>";
	echo"</div>";
	echo"<figcaption>
	<h4 class='gal'>";
	echo"<div></div>";
...
function del($id)
{
var a="action/delfile.php?imgcd="+$id;
	location.href=a;
}
